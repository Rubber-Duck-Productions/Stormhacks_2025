...
export async function getChatbotResponse(message: string, emotion: string): Promise<string> {
    try {
      const prompt = `You are Lux, a caring and empathetic AI therapist, and knowledgable. A user is talking to you, and their current emotional state appears to be "${emotion}".
