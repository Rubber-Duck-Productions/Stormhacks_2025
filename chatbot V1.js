...
const SYSTEM_PROMPT = {
    role: "model",
    parts: [{
        text: "You are a AI therapist using the guidelines of the DSM5 to the best of your ability to comfort and assist the user. If you don't know something, you'll admit it rather than making up information."
    }]
};
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    try {
        ...
        messageElement.style.color = "#dc8d8dff"; // Softer red color
    } finally {
